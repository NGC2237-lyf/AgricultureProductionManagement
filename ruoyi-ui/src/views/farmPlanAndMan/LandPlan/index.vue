<template>
  <div>
    <!-- 使用土地信息表格组件 -->
    <Table  title="土地信息" :totalNum="page.totalNum" :columns="tableColumns" :data="landData" @delete="handleDelete" @currentpagechange="handleCurrentPageChange" @save="handleSave" @add="handleAdd" />
  </div>
</template>
