...
public class AgriculturalMarketingSalesController {
    ...
    @GetMapping("/products/{pageNum}/{pageSize}")
    public AjaxResult getProducts(@RequestParam(value = "p",required = false) String productName,@PathVariable("pageNum") Integer pageNum, @PathVariable("pageSize") Integer pageSize) {
